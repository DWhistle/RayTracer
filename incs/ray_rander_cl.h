#ifndef RAY_RENDER_CL_H
# define RAY_RENDER_CL_H
# include "objects.h" 
#  include "quat.h"

t_point_data   	path_tracing(__global t_scene *scene, t_vec vec, t_accuracy accuracy, t_vec point);
...
t_point_data    raymarching(__global t_scene *objs, t_vec vec, t_accuracy accuracy, t_vec point, int ignore);
t_vec			get_normal(t_vec point, t_obj obj);
double          light_render(__global t_scene *objs, t_point_data point_data, t_vec n);
